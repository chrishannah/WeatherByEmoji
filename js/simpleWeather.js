...
!function(e) {
    ...
    e.extend({
        simpleWeather: function(i) {
            ...
            if ("" !== i.location) {
                n += 'select * from weather.forecast where woeid in (select woeid from geo.placefinder where text="' + i.location + '" and gflags="R" limit 1) AND title NOT LIKE "%Error%" and u="' + i.unit + '"';
